...
type C2SLogin struct {
	...
	Token  string           `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`                                                                                            // 登陆token(web login api生成的base64字符串)
	Params map[int32]string `protobuf:"bytes,2,rep,name=params,proto3" json:"params,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 登陆时上传的参数 key: LoginParams
}
...
func (x *C2SLogin) GetParams() map[int32]string {
	if x != nil {
		return x.Params
	}
	return nil
...
type S2CLogin struct {
	...
	Params map[int32]string `protobuf:"bytes,2,rep,name=params,proto3" json:"params,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 登陆后的扩展参数，按需增加
}
...
func (x *S2CLogin) GetParams() map[int32]string {
	if x != nil {
		return x.Params
	}
	return nil
...
var file_login_proto_rawDesc = []byte{
	...
	0x62, 0x22, 0x8d, 0x01, 0x0a, 0x08, 0x43, 0x32, 0x53, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x14,
	0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x30, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x32, 0x53, 0x4c, 0x6f, 0x67,
	0x69, 0x6e, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06,
	...
	0x01, 0x22, 0x89, 0x01, 0x0a, 0x08, 0x53, 0x32, 0x43, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x10,
	0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64,
	0x12, 0x30, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x32, 0x43, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x2e, 0x50,
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x05, 0x5a,
...
var file_login_proto_goTypes = []interface{}{
	(*C2SLogin)(nil), // 0: pb.C2SLogin
	(*S2CLogin)(nil), // 1: pb.S2CLogin
	nil,              // 2: pb.C2SLogin.ParamsEntry
	nil,              // 3: pb.S2CLogin.ParamsEntry
}
var file_login_proto_depIdxs = []int32{
	2, // 0: pb.C2SLogin.params:type_name -> pb.C2SLogin.ParamsEntry
	3, // 1: pb.S2CLogin.params:type_name -> pb.S2CLogin.ParamsEntry
